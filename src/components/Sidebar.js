...
const Sidebar = () => {
  ...
  return (
    <>
      <aside className="min-w-[200px] shadow-md h-screen" aria-label="Sidebar">
        <div className="px-3 py-4 overflow-y-auto rounded bg-white-50 ">
          ...
          <Link
            ...
            className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ${
              url.pathname === '/dashboard' ? 'bg-teal-100 font-semibold' : ''
            }`}
          >
            <svg
              className="w-6 h-6"
          ...
          <Link
            ...
            href="#"
            className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ${
              url.pathname === '/dashboard/create-data'
          ...
          >
            ...
            <span className="ml-3 text-sm">Create Data</span>
          </Link>
          <Link
            to="/dashboard/job-data"
            href="#"
            className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ${
              url.pathname === '/dashboard/job-data'
                ? 'bg-teal-100 font-semibold'
                : ''
            }`}
          >
            ...
            <span className="ml-3 text-sm">Jobs Database</span>
          </Link>
          <div className="my-6">
            <span className="px-3 text-gray-500 font-semibold  text-sm">
              Manage User
